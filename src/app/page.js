...
const Section1 = ({ data }) => {
  return (
    <div className="bg-gradient-to-b  from-[#FFFFFF] to-[#B6F1F0] relative">
      ...
      <div className="flex lg:flex-row lg:gap-0 py-4 justify-between w-[90%] md:w-[80%] m-auto flex-col-reverse  gap-11 md:gap-6">
        <div className="flex flex-col md:gap-2 gap-6 lg:w-[50%] w-[100%]">
          ...
          <div className="flex flex-col gap-4 m-auto text-left md:text-center lg:m-0">
            <p className="text-[1rem] font-light font-[#000] hidden  md:block" dangerouslySetInnerHTML={{ __html: `<span>${data.text}</span>` }}></p>
            <div className="md:m-auto z-[100]"><Button data={data.button} /></div>
          </div>
        </div>
...
const Section2 = ({ data }) => {
  return (
    <div className="bg-gradient-to-b from-[#CBE5E5] to-[#CBE5E5] pt-[200px] flex flex-col items-center justify-center gap-[5rem] relative">
      ...
      <div className="flex md:flex-row items-center flex-col  gap-10 justify-evenly text-[1.1rem] text-center">
        <div className="md:w-[33%] w-[90%] p-6 py-8 font-light text-white bg-[#121316] rounded-xl leading-7 tracking-wide"><p>{data.cardOne}</p></div>
        <div className="md:w-[33%] w-[90%]  p-6 py-8 font-light text-black bg-[#D9A4FD] rounded-xl leading-7 tracking-wide"><p>{data.cardTwo}</p></div>
      </div>
    </div>
  )
}
...
const Section3 = ({ data }) => {
  ...
  return (
    <div ref={sectionRef} className="bg-gradient-to-tr  from-[#CEFD82] to-[#83D34A] h-auto relative cursor-default">
      ...
      <div className="flex justify-evenly w-[100%] md:w-[80%] m-auto p-6 py-16 relative">
        <div className="flex flex-col justify-evenly z-10">
          {data.features.map((item, index) => (
            <div className="w-fit" onClick={() => handleClick(index)} key={index} style={{ position: 'relative' }}>
              <p
                className={`md:text-3xl text-xl font-extralight capitalize md:leading-[4.5rem] leading-10 p-2 md:p-4 text-center transition-all duration-150 ${active === index ? 'active' : ''
                  }`}
                style={{
        ...
        <div style={{ backgroundImage: 'url(./section3.png)' }} className="flex items-center justify-center flex-col w-[55%] lg:w-[60%] bg-[#CEEADC] border-solid border-black border-[3px] rounded-md">
          {data.features.map((item, index) => (
            <p
              key={index}
...
const Section5 = ({ data }) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b  from-[#E4E6F8] to-[#9EA3FA] flex items-center flex-col gap-[3.5rem]">
      ...
      <div className="flex flex-col md:w-[40%] w-[90%] gap-10">
          ...
          <div key={index}>
            <div onClick={() => setOpenIndex(openIndex === index ? null : index)} className="flex justify-between px-5 py-7 hover:bg-[#C2DAFF] bg-[#E0ECFF] rounded-md transition-all duration-300 ease-in-out">
              ...
              <div className={openIndex === index ? 'transform rotate-180 transition-transform duration-300 ease' : 'transition-transform duration-300 ease'}>
                <svg width="100%" height="25" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div className="bg-gradient-to-b  from-[#FFFFFF] to-[#B6F1F0]">
      <div className="flex flex-col md:flex-row md:pl-28 py-10 gap-10">
        <div className="md:w-[70%] flex flex-col gap-16 items-center">
          ...
          <p className="text-[1.1rem] font-light w-[80%] md:w-[85%]" dangerouslySetInnerHTML={{ __html: `<span>${data.text}</span>` }} ref={ref}></p>
        </div>
        <div className="w-[50%] m-auto" >
          <motion.svg
            initial={{ opacity: 0 }}
            animate={{
              y: isVisible ? [-500, 150, 0] : 0,
              opacity: 1,
              transition: { duration: 0.3, ease: "easeInOut" }
            }}
            className="m-auto" width="50%" height="auto" viewBox="0 0 115 107" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <defs>
              ...
              <linearGradient id="paint4_linear_222_994" x1="67.7221" y1="23.2245" x2="38.3303" y2="77.8175" gradientUnits="userSpaceOnUse">
                <stop stop-color="#E9ED1F" />
                <stop offset="1" stop-color="#299F4E" />
              </linearGradient>
            </defs>
          </motion.svg>
        </div>
      ...
      <svg width="1920" height="163" viewBox="0 0 1920 163" fill="none" xmlns="http://www.w3.org/2000/svg" >
        ...
        <path fill-rule="evenodd" clip-rule="evenodd" d="M0 19.0296V163H1920V71C1920 71 1663.95 0 1431 0C1311.87 0 1191.91 24.6964 1061.29 51.5879C905.186 83.7264 733.85 119 530.5 119C345.868 119 0 19.0296 0 19.0296Z" fill="url(#svgGradient)" />
      </svg>
    </div>
  )
}
  ...
  return (
    <div className="bg-gradient-to-b from-[#E4E6F8] to-[#9EA3FA] ">
      ...
      <svg width="1920" height="120" viewBox="0 0 1920 120" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path fill-rule="evenodd" clip-rule="evenodd" d="M0 14.0001V119.999H1920V48.4086C1920 48.4086 1634.74 9.15527e-05 1431 9.15527e-05C1297.49 9.15527e-05 1150.47 22.8407 1000.22 46.1816C843.251 70.5678 682.763 95.5001 530.5 95.5001C285.376 95.5001 0 14.0001 0 14.0001Z" fill="#fff" />
      </svg>
